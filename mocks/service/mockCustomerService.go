...
// Source: github.com/jeffleon/banking-hexarch/service (interfaces: CustomerService)
...
func (m *MockCustomerService) GetAllCustomers(arg0 string) ([]domain.Customer, *errs.AppError) {
	m.ctrl.T.Helper()
